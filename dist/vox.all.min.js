...
var VoxBinder=function(){var t={};t._mapping={},t._typeDef={int:function(e){return parseInt(e)},float:function(e){return parseFloat(e)},currency:function(e){return Vox.toFormattedCurrency(e)},string:function(e){return e.toString()}},t.init=function(e){null==e&&(t.ctx=window),t.update(),t.ctx.addEventListener("DOMNodeInserted",function(e){e.srcElement.attributes&&"undefined"!=typeof e.srcElement.attributes[Vox.attrBind]&&t.bindElement(e.srcElement)})},t.update=function(){for(var e=Vox.getAllElementsByAttr(Vox.attrBind),n=0;n<e.length;n++)t.bindElement(e[n])},t.bindGetterSetter=function(e,n,r,o,i){if("undefined"==typeof e)return!1;var u=n.indexOf(".");return u>-1?t.bindGetterSetter(e[n.substring(0,u)],n.substr(u+1),r,o,i):("undefined"==typeof e[n]&&(e[n]="undefined"!=typeof o.value&&o.value?o.value:""),void Object.defineProperty(e,n,{get:function(){return Vox.binder._mapping[r]},set:function(e){var t=o.getAttribute(Vox.attrValueType);e=Vox.binder.castValue(t,e),o[i]=e,Vox.binder._mapping[r]=e}}))},t.castValue=function(e,n){return null==e?n:(e=e.toLowerCase(),"undefined"!=typeof t._typeDef[e]?t._typeDef[e](n):void 0)},t.bindElement=function(e){var n=e.getAttribute(Vox.attrBind),r=n.split(/[\.\[\]\"\']{1,2}/),o=r.shift(),i=t.ctx[o],u=Vox.getElementDef(e),a=Vox.elementValue(i,r.join("."));t._mapping[n]=a,t.bindGetterSetter(i,r.join("."),n,e,u.valueDOM),null!=u&&("undefined"==typeof a&&(a=""),e[u.valueDOM]=a,e.addEventListener(u.eventType,function(){var r=e[u.valueDOM],o=e.getAttribute(Vox.attrValueType);r=Vox.binder.castValue(o,r),e[u.valueDOM]=r,t._mapping[n]=r},!1))};var n=Array.prototype.push,r=Array.prototype.pop,o=Array.prototype.splice;return Array.prototype.push=function(){if(ins=n.apply(this,arguments),this._vox_observe){var e=this._vox_observe,t=this._vox_values;Vox.binder.insertRow(this[this.length-1],e,t)}return ins},Array.prototype.pop=function(){return e=r.apply(this,arguments),this._vox_observe&&t.removeRow(this._vox_observe),e},Array.prototype.splice=function(){if(e=o.apply(this,arguments),this._vox_observe){var n=arguments.length>1?arguments[1]:1;t.removeRow(this._vox_observe,arguments[0],n)}return e},t.insertRow=function(e,n,r){for(var o=t.ctx.document.getElementById(n),i=o.rows.length,u=r.length,a=o.insertRow(i),s=0;s<u;s++){var l=a.insertCell(s),p=Vox.getValuePath(e,r[s]);l.innerHTML=p}},t.removeRow=function(e,n,r){var o=t.ctx.document.getElementById(e);if(n)if(r)for(var i=n+1,u=0;u<r;)o.deleteRow(i),u++;else o.deleteRow(n);else o.deleteRow(o.rows.length-1)},t.bindTable=function(e,n,r){e._vox_observe=n,e._vox_values=r,Vox.forEach(e,function(e){t.insertRow(e,n,r)})},t}();
