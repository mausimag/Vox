...
var Vox=function(){var e={};return e.ctx=null,e.binder=VoxBinder,e.attrBind="vox-bind",e.attrValueType="vox-value-type",e.validation=VoxValidation,e.attrPattern="vox-pattern",e.attrRequired="vox-required",e.attrInvalidMessage="vox-message",e.ajax=VoxAjax,e.locale=VoxLocale,e.attrLabel="vox-label",e.listeners=[],e.bootstrap=function(){},e.elementDef={input:{text:{valueDOM:"value",eventType:"keyup"},checkbox:{valueDOM:"checked",eventType:"change"}},textarea:{valueDOM:"value",eventType:"keyup"},select:{valueDOM:"value",eventType:"change"}},e.getElementDef=function(t){var n=t.tagName?t.tagName.toLowerCase():"input",a=t.type?t.type.toLowerCase():"text",r=null;return"undefined"!==e.elementDef[n]&&(r=n.indexOf("input")>-1?e.elementDef[n][a]:e.elementDef[n]),r},e.forEach=function(e,t){for(var n=e.length,a=0;a<n;a++)t(e[a],a,e)},e.getAllElementsByAttr=function(e){for(var t=[],n=document.getElementsByTagName("*"),a=0;a<n.length;a++)null!==n[a].getAttribute(e)&&t.push(n[a]);return t},e.elementValue=function(t,n){if("undefined"==typeof t)return!1;var a=n.indexOf(".");return a>-1?e.elementValue(t[n.substring(0,a)],n.substr(a+1)):t[n]},e.getObjectAttr=function(e,t){if("undefined"!=typeof t&&null!==t){e=e.split(/[\.\[\]\"\']{1,2}/);for(var n=0,a=e.length;n<a;n++)if(""!==e[n]&&(t=t[e[n]],"undefined"==typeof t||null===t))return;return t}},e.getValuePath=function(t,n){if("undefined"==typeof t)return!1;var a=n.indexOf(".");return a>-1?e.getValuePath(t[n.substring(0,a)],n.substr(a+1)):t[n]},e}();
