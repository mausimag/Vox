...
var VoxBinder=function(){var t={};t.mapping={},t.elementDef={input:{text:{valueDOM:"value",eventType:"keyup"},checkbox:{valueDOM:"checked",eventType:"change"}},textarea:{valueDOM:"value",eventType:"keyup"},select:{valueDOM:"value",eventType:"change"}},t.init=function(e){null==e&&(t.ctx=window),t.update(),t.ctx.addEventListener("DOMNodeInserted",function(e){e.srcElement.attributes&&"undefined"!=typeof e.srcElement.attributes[Vox.attrBind]&&t.bindElement(e.srcElement)})},t.update=function(){for(var e=Vox.getAllElementsByAttr(Vox.attrBind),n=0;n<e.length;n++)t.bindElement(e[n])},t.bindGetterSetter=function(e,n,r,o,i){if("undefined"==typeof e)return!1;var a=n.indexOf(".");return a>-1?t.bindGetterSetter(e[n.substring(0,a)],n.substr(a+1),r,o,i):("undefined"==typeof e[n]&&(e[n]="undefined"==typeof o.value?"":o.value),void Object.defineProperty(e,n,{get:function(){return t.mapping[r]},set:function(e){o[i]=e,t.mapping[r]=e}}))},t.bindElement=function(e){var n=e.getAttribute(Vox.attrBind),r=n.split(/[\.\[\]\"\']{1,2}/),o=r.shift(),i=t.ctx[o],a=e.tagName?e.tagName.toLowerCase():"input",u=e.type?e.type.toLowerCase():"text",l=null;"undefined"!==t.elementDef[a]&&(l=a.indexOf("input")>-1?t.elementDef[a][u]:t.elementDef[a]);var s=Vox.elementValue(i,r.join("."));t.mapping[n]=s,t.bindGetterSetter(i,r.join("."),n,e,l.valueDOM),null!=l&&(e[l.valueDOM]=s,e.addEventListener(l.eventType,function(){var r=e[l.valueDOM],o=e.getAttribute(Vox.attrValueType);if(o)switch(o.toLowerCase()){case"int":r=parseInt(r);break;case"float":r=parseFloat(r);break;case"string":default:r=r.toString()}t.mapping[n]=r},!1))};var n=Array.prototype.push,r=Array.prototype.pop,o=Array.prototype.splice;return Array.prototype.push=function(){if(ins=n.apply(this,arguments),this._vox_observe){var e=this._vox_observe,t=this._vox_values;Vox.binder.insertRow(this[this.length-1],e,t)}return ins},Array.prototype.pop=function(){return e=r.apply(this,arguments),this._vox_observe&&t.removeRow(this._vox_observe),e},Array.prototype.splice=function(){if(e=o.apply(this,arguments),this._vox_observe){var n=arguments.length>1?arguments[1]:1;t.removeRow(this._vox_observe,arguments[0],n)}return e},t.insertRow=function(e,n,r){for(var o=t.ctx.document.getElementById(n),i=o.rows.length,a=r.length,u=o.insertRow(i),l=0;l<a;l++){var s=u.insertCell(l),p=Vox.getValuePath(e,r[l]);s.innerHTML=p}},t.removeRow=function(e,n,r){var o=t.ctx.document.getElementById(e);if(n)if(r)for(var i=n+1,a=0;a<r;)o.deleteRow(i),a++;else o.deleteRow(n);else o.deleteRow(o.rows.length-1)},t.bindTable=function(e,n,r){e._vox_observe=n,e._vox_values=r,Vox.forEach(e,function(e){t.insertRow(e,n,r)})},t}();
...
var Vox=function(){var e={};return e.ctx=null,e.binder=VoxBinder,e.attrBind="vox-bind",e.attrValueType="vox-value-type",e.validation=VoxValidation,e.attrPattern="vox-pattern",e.attrRequired="vox-required",e.attrInvalidMessage="vox-message",e.ajax=VoxAjax,e.locale=VoxLocale,e.attrLabel="vox-label",e.listeners=[],e.bootstrap=function(){},e.forEach=function(e,t){for(var n=e.length,r=0;r<n;r++)t(e[r],r,e)},e.getAllElementsByAttr=function(e){for(var t=[],n=document.getElementsByTagName("*"),r=0;r<n.length;r++)null!==n[r].getAttribute(e)&&t.push(n[r]);return t},e.elementValue=function(t,n){if("undefined"==typeof t)return!1;var r=n.indexOf(".");return r>-1?e.elementValue(t[n.substring(0,r)],n.substr(r+1)):t[n]},e.getObjectAttr=function(e,t){if("undefined"!=typeof t&&null!==t){e=e.split(/[\.\[\]\"\']{1,2}/);for(var n=0,r=e.length;n<r;n++)if(""!==e[n]&&(t=t[e[n]],"undefined"==typeof t||null===t))return;return t}},e.getValuePath=function(t,n){if("undefined"==typeof t)return!1;var r=n.indexOf(".");return r>-1?e.getValuePath(t[n.substring(0,r)],n.substr(r+1)):t[n]},e}();
VoxBinder.elementDef["ons-input"]={text:{valueDOM:"value",eventType:"keyup"},number:{valueDOM:"value",eventType:"change"},date:{valueDOM:"value",eventType:"change"},time:{valueDOM:"value",eventType:"change"}};